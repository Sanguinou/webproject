...
<body>
    <div class="welcomeGrid">
        ...
        <div>
            ...
            <div class="topMerchGrid">
                <form>
                <input type="button" class="buttonNetwork center" style="background-image: url({{ asset('image/fblogo.png') }}" onclick="window.location.href='http://www.facebook.com/CesiCampusArras/?ref=br_rs'" />
                </form>
                <form>
                <input type="button" class="buttonNetwork center" style="background-image: url({{ asset('image/tlogo.png') }}" onclick="window.location.href='https://twitter.com/eXiaCesiArras'" />
                </form>
                <form>
                <input type="button" class="buttonNetwork center" style="background-image: url({{ asset('image/cesilogo.png') }}" onclick="window.location.href='http://www.cesi.fr/'" />
                </form>   
             </div>
        </div> 
    </div>
