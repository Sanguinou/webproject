        ...
        <div>
            ...
            <div class="welcomeEventGrid">
                <div>
                    ...
                    <button class="buttonStyle1 buttonEventPos" onclick="location.href = 'http://127.0.0.1:8000/connection';">S'inscrire maintenant ></button>
                </div>
                <div>
