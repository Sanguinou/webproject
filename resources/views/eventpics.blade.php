...
<body>
    ...
    <div>
        <img class="picEvent imgPos center" style="background-image: url({{ asset('image/bgevent.jpg') }}" width="1000" height="600">
    ...
    <div>
        <img class="picEvent imgPos center" style="background-image: url({{ asset('image/bgevent2.jpg') }}" width ="1000" height="600">
        <div class=eventPicGrid>
            ...
            <div>
                ...
                <div class="ideaBoxName2" width="200" height="75" style="left: 3%; border: transparent;"> <b>Logan Paul</b> </div>
            </div>
        </div>
            <div class="commentGrid eventDescPic center" style="height: 175px; padding: 0;">
                ...
                <div>
                    ...
                    <div class="commentGridpost">
                        <div class="post center">POST : 12/11/2018 5:45 PM</div>
                        <button class="buttonStyle3 likePos center" style="width: 100px">SUPPR</button>
                        <button class="buttonStyle3 likePos center" style="width: 100px">SIGNALER</button>
                    </div>
                </div> 
            </div>
            <div class="commentGrid eventDescPic center" style="height: 175px; padding: 0;">
